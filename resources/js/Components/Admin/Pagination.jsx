        ...
        return (
            <nav className="d-flex justify-content-end">
                <ul className="pagination pagination-gutter">
                    <PaginationItem onClick={this.props.onClick} url={this.previous} disabled={this.previous == null} indicator={true}><i className="la la-angle-left"></i></PaginationItem>
                    ...
                    <PaginationItem onClick={this.props.onClick} url={this.next} disabled={this.next == null} indicator={true}><i className="la la-angle-right"></i></PaginationItem>
                </ul>
            </nav>
        );
    }
