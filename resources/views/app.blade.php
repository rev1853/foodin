                        ...
                        <ul class="navbar-nav header-right main-notification">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="#" role="button" data-toggle="dropdown">
                                    <img src="{{ url('/') }}/zenix/images/profile/pic1.jpg" width="20"
                                        alt="">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <div class="main-profile">
                    <div class="image-bx">
                        <img src="{{ url('/') }}/zenix/images/Untitled-1.jpg" alt="">
                    </div>
                    <h5 class="name"><span class="font-w400">Hello,</span> Marquez</h5>
                    <p class="email"><a class="__cf_email__"
                            data-cfemail="95f8f4e7e4e0f0efefefefd5f8f4fcf9bbf6faf8">emailku@email.com</a></p>
                </div>
                ...
                <div class="copyright">
                    ...
                    <p class="fs-12">Powered <span class="heart"></span> by DexignZone</p>
                </div>
            </div>
        </div>
        <!--**********************************
